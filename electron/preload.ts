...
const api: DocuGenApi = {
  ...
  pickTenderEvalFolder: () => ipcRenderer.invoke(IPC.pickTenderEvalFolder),
  readFileBase64: (filePath) => ipcRenderer.invoke(IPC.readFileBase64, filePath),
  listDriveFolderTenderFiles: (link) => ipcRenderer.invoke(IPC.listDriveFolderTenderFiles, link),
  downloadDriveFile: (id) => ipcRenderer.invoke(IPC.downloadDriveFile, id),
